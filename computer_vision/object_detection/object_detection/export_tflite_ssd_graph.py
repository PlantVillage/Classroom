...
flags.DEFINE_string('output_directory', '/home/plantvillage/Dropbox/Object_Detection/model_development/potato/model/tflite_files', 'Path to write outputs.')
flags.DEFINE_string(
    'pipeline_config_path', '/home/plantvillage/Dropbox/Object_Detection/model_development/potato/model/configs/ssdlite_mobilenet_v2_potato.config',
    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', '/home/plantvillage/Dropbox/Object_Detection/model_development/potato/model/event_logs/11-20/19/19.0/model.ckpt-104375', 'Checkpoint prefix.')
flags.DEFINE_integer('max_detections', 30,
